...
function initializeDataTable() {
    let table = new DataTable("#ajax-datatables", {
        ...
        columnDefs: [
            ...
            // { className: "text-end align-content-center", targets: [13, 14] }, // 10 번째 열에 우측 정렬 클래스 추가
        ],
    });
}
...
function loadTableData(table, callback) {
    ...
    callApi("POST", "/admin/back/04-estate/estate_list_deleted.php", { ...adminUserInfo(), public_fg: filterValue }, "loading")
        .then((result) => {
            if (!result) {
                console.log("통신 실패!!!");
            ...
            const formattedData = responseData.map((item, index) => {
                ...
                return {
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a href="/admin/views/re_manage/re_detail_deleted.html?no=${item.estate_no}" class="dropdown-item">
