...
function loadTableData(table, callback) {
    ...
    callApi("POST", "/admin/back/04-estate/estate_list_v2.php", { ...adminUserInfo(), public_fg: filterValue }, "loading")
        .then((result) => {
            if (!result) {
                console.log("통신 실패!!!");
            ...
            const formattedData = responseData.map((item, index) => {
                ...
                const descBtn = `<a class="link-dark link-body-emphasis link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-75-hover" href="/admin/views/re_manage/re_detail_v2.html?no=${item.estate_no}">${addressTotal}</a>`;
                ...
                return {
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a href="/admin/views/re_manage/re_detail_v2.html?no=${item.estate_no}" class="dropdown-item">
