...
$sgg_cd = isset($_POST['sgg_cd']) ? urldecode($_POST['sgg_cd']) : '';
$umd_cd = isset($_POST['umd_cd']) ? urldecode($_POST['umd_cd']) : '';
...
try {
    ...
    mysqli_stmt_bind_param($stmt, "sss", $sido_cd, $sgg_cd, $umd_cd);
