...
$top_fg = isset($_POST['top_fg']) ? urldecode($_POST['top_fg']) : 'N';

##################### 0. 유효성 검사 #####################
// 은행명 유효성 검사
$errorMessage = "영업점 이름을 확인해주세요.";
...
try {
    ...
    if (!mysqli_stmt_bind_param($stmt, "sddsi", $name, $max_loan_amount, $min_loan_rate, $top_fg, $b_no)) {
