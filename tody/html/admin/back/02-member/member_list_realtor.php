...
// SQL 쿼리
$sql = "SELECT a.user_no, a.id, a.agency_name, a.registered_broker_name, a.email, a.phone, a.mobile, 
            a.address_primary, a.address_detail, DATE_FORMAT(a.reg_date, '%Y-%m-%d') AS reg_date, 
