...
// SQL 쿼리
$sql = "SELECT a.user_no, a.id, a.name, a.mobile, 
            DATE_FORMAT(a.reg_date, '%Y-%m-%d') AS reg_date, 
            a.status_code, b.description_ko AS status_description,
            c.name AS b_name, d.name AS c_name
        ...
        LEFT JOIN finance_branches AS c
        ON c.manager_no = a.user_no

        LEFT JOIN finance_company AS d
        ON c.finance_company_idx = d.idx
