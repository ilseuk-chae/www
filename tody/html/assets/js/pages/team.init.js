                                    ...
                                    <div class="team-profile-img">
                                        ...
                                        <div class="team-content">
                                            <a class="member-name" data-bs-toggle="offcanvas" href="#member-overview" aria-controls="member-overview">
                                                <h5 class="fs-16 mb-1">${e.memberName}</h5>
                                            </a>
                                ...
                                <div class="col-lg-4 col">
                                    <div class="row text-muted text-center">
                                        <div class="col-6 border-end border-end-dashed">
                                            <h5 class="mb-1 projects-num">${e.projects}</h5>
                        ...
                        ? (e.preventDefault(),
                          ...
                          "" === t || "" === r || editlist
                              ? "" !== t &&
                                ...
                                (editlist = !1))
                              : ((l = findNextId()),
                                allmemberlist.push({ id: l, coverImg: i, bookmark: !1, memberImg: n, nickname: a, memberName: t, position: r, projects: "0", tasks: "0" }),
                                sortElementsById()),
