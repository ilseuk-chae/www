...
try {
    ...
    if (isset($register_stmt)) {mysqli_stmt_close($register_stmt);}
    if (isset($update_hmac_stmt)) {mysqli_stmt_close($update_hmac_stmt);}
    if (isset($update_token_stmt)) mysqli_stmt_close($update_token_stmt);
    if (isset($select_token_stmt)) mysqli_stmt_close($select_token_stmt);
    mysqli_close($conn);
}
