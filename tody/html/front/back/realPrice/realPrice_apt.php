        ...
        foreach ($requested_estate_types as $type) {
            switch ($type) {
                ...
                case 'land':
                    ...
                    break;
                case 'single':
                    $union_queries[] = $single_query_template;
                    //$params[] = $pnu_filter_value;
                    break;
                case 'commercial':
                    $union_queries[] = $commercial_query_template;
                    //$params[] = $pnu_filter_value;
                    break;
                case 'factory':
                    $union_queries[] = $factory_query_template;
                    //$params[] = $pnu_filter_value;
                    break;
