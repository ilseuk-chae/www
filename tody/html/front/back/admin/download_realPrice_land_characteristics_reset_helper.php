<?php
// download_realPrice_land_characteristics_reset_helper.php
//trigger_characteristics_batch_cli.php에 의해 호출되며, Redis 초기화 로직만 수행하고 간단한 성공/실패 메시지를 반환합니다.
...
try {
    ...
    echo sprintf("Removed %d land_pnu hashes and %d land_pnu_idx entries. SUCCESS", $deletedPnu, $deletedIdx) . PHP_EOL;
