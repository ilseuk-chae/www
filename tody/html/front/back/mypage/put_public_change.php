...
$put_no = isset($_POST['put_no']) ? urldecode($_POST['put_no']) : '';
...
$valid = validateInput($put_no, 'int', $errorMessage, array());
if ($valid == $errorMessage) {
    responseApi(400, $errorMessage, null);
    exit;
}
...
try {
    ...
    mysqli_stmt_bind_param($stmt, "ssi", $public_fg, $user_no, $put_no);
