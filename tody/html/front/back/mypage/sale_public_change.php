...
$rcv_no = isset($_POST['rcv_no']) ? urldecode($_POST['rcv_no']) : '';
...
$valid = validateInput($rcv_no, 'int', $errorMessage, array());
if ($valid == $errorMessage) {
    responseApi(400, $errorMessage, null);
    exit;
}
...
try {
    ...
    mysqli_stmt_bind_param($stmt, "siii", $public_fg, $user_no, $rcv_no, $user_no);
