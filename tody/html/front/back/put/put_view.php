...
try {
    ...
    // // 지점 정보 추가
    // if (!empty($response_data[0]['file_path'])) {
    //     $filePath = $response_data[0]['file_path'];
    //     $token = getToken($filePath, $response_data[0]['put_no']);
    //     $response_data[0]['imageArray'] = array()
    //     $response_data[0]['imageToken'] = $token;
    // }
