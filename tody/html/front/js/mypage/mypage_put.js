...
function loadTableData(table, callback) {
    ...
    callApi("POST", "/front/back/mypage/put_list.php", dataObj, "loading")
        .then((result) => {
            if (!result) {
                console.log("통신 실패!!!");
                ...
                return {
                    ...
                    management: `
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a href="/front/views/put/put_view.html?viewNo=${item.put_no}" class="dropdown-item">
                                        <i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                        상세
                                    </a>
                                </li>
                                <li>
                                    <a href="/front/views/put/put_modify.html?viewNo=${item.put_no}" class="dropdown-item">
